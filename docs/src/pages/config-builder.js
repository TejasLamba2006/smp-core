...
${generateYAML(generatedConfig)}`;
    ...
    if (loading) {
        return (
            <Layout title="Config Builder" description="Interactive configuration generator for SMP Core">
                ...
                <div className="container">
                    <div className={styles.header}>
                        ...
                        <p className={styles.subtitle}>
                            Build your perfect SMP Core configuration interactively
                        </p>
                        {manifest && (
                    ...
                    <div className={styles.mainLayout}>
                        ...
                        <div className={styles.outputPanel}>
                            ...
                            <div className={styles.outputTip}>
                                <strong>Tip:</strong> Place this file in your server's <code>plugins/SMP-Core/</code> folder, then run <code>/smp reload</code>
                            </div>
                        </div>
                    </div>
                </div>
